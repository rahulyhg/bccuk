...
class UberGallery {
     ...
     * @access public
     */
    public function createGallery($directory, $relText = 'colorbox', $limit = 100) {
  ...
  // <div class="col-xs-6 col-md-3">
        ...
        echo '    <div id="galleryList" class="row clearfix">' . PHP_EOL;
        
        foreach (array_slice($gallery['images'], 0, $limit) as $image) {
            echo "            <div class=\"col-xs-6 col-md-3\"><a class=\"thumbnail\" href=\"{$image['file_path']}\" title=\"{$image['file_title']}\" rel=\"{$relText}\"><img src=\"{$image['thumb_path']}\" alt=\"{$image['file_title']}\"/></a></div>" . PHP_EOL;
        }
        ...
        if ($gallery['stats']['total_pages'] > 1) {
            echo '        <ul id="galleryPagination" class="pagination">' . PHP_EOL;
